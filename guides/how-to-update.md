...
The new database is now installed and ready for use. However, note that previous functions have been replaced by new ones. Please consult our documentation and review the full changelog at [ForgeDB Documentation](https://docs.botforge.org/p/ForgeDB/) for details on these changes.
